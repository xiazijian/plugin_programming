package com.xia.demo.core;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.xia.demo.util.Configuration;
...
public class PluginLoader {
    ...
    static {
        ...
        System.out.println("JSONArray："+ls);
        ...
        System.out.println("pluginMap："+pluginMap);
    ...
    private static String getConfPath(){
        ...
        System.out.println("xwy dir："+dir);
        ...
        System.out.println("配置文件路径："+confDir);
        return confDir;
    }
